 ...
 */
final class Version20241218162919 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE preference (id INT AUTO_INCREMENT NOT NULL, user_id INT NOT NULL, type_pr VARCHAR(255) DEFAULT NULL, disponibilite_ac DATETIME DEFAULT NULL, INDEX IDX_5D69B053A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE ressource_de_revision (id INT AUTO_INCREMENT NOT NULL, matiere_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, INDEX IDX_1091F923F46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE sessionrevision (id INT AUTO_INCREMENT NOT NULL, user_id INT DEFAULT NULL, matiere_id INT DEFAULT NULL, date_debut DATETIME DEFAULT NULL, duree_allouee INT NOT NULL, duree_reelle INT DEFAULT NULL, objectif_atteint TINYINT(1) DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, INDEX IDX_BF376EBA76ED395 (user_id), INDEX IDX_BF376EBF46CD258 (matiere_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, reset_token VARCHAR(64) DEFAULT NULL, prenom VARCHAR(255) NOT NULL, email VARCHAR(255) NOT NULL, roles JSON NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, solde_m DOUBLE PRECISION NOT NULL, age INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE ressource_de_revision ADD CONSTRAINT FK_1091F923F46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id)');
        $this->addSql('ALTER TABLE sessionrevision ADD CONSTRAINT FK_BF376EBA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE sessionrevision ADD CONSTRAINT FK_BF376EBF46CD258 FOREIGN KEY (matiere_id) REFERENCES matiere (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ressource_de_revision DROP FOREIGN KEY FK_1091F923F46CD258');
        $this->addSql('ALTER TABLE sessionrevision DROP FOREIGN KEY FK_BF376EBA76ED395');
        $this->addSql('ALTER TABLE sessionrevision DROP FOREIGN KEY FK_BF376EBF46CD258');
        ...
        $this->addSql('DROP TABLE ressource_de_revision');
        $this->addSql('DROP TABLE sessionrevision');
