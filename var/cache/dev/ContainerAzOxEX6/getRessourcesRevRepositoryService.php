 ...
 */
class getRessourcesRevRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\RessourcesRevRepository' shared autowired service.
     *
     * @return \App\Repository\RessourcesRevRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'RessourcesRevRepository.php';

        return $container->privates['App\\Repository\\RessourcesRevRepository'] = new \App\Repository\RessourcesRevRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
