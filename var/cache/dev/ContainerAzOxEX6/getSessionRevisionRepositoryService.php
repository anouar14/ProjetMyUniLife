 ...
 */
class getSessionRevisionRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SessionRevisionRepository' shared autowired service.
     *
     * @return \App\Repository\SessionRevisionRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SessionRevisionRepository.php';

        return $container->privates['App\\Repository\\SessionRevisionRepository'] = new \App\Repository\SessionRevisionRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
