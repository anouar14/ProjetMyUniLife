...
class __TwigTemplate_28b0394d59d3573c82d25665fc11631e extends Template
{
    ...
    protected function doDisplay(array $context, array $blocks = []): iterable
    {
        ...
        $this->parent = $this->loadTemplate("depense.html.twig", "categorie/show.html.twig", 1);
    ...
    <table class=\"table\">
        ...
        yield "</td>
            ...
            <tr>
                ...
                <td>";
        // line 16
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 16, $this->source); })()), "nomCat", [], "any", false, false, false, 16), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>MontanMax</th>
                <td>";
        // line 20
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 20, $this->source); })()), "montanMax", [], "any", false, false, false, 20), "html", null, true);
        yield "</td>
            </tr>
            <tr>
                <th>MontantCat</th>
                <td>";
        // line 24
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape(CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 24, $this->source); })()), "montantCat", [], "any", false, false, false, 24), "html", null, true);
        yield "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 31
        yield $this->env->getRuntime('Twig\Runtime\EscaperRuntime')->escape($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("app_categorie_index", ["id" => CoreExtension::getAttribute($this->env, $this->source, (isset($context["categorie"]) || array_key_exists("categorie", $context) ? $context["categorie"] : (function () { throw new RuntimeError('Variable "categorie" does not exist.', 31, $this->source); })()), "id", [], "any", false, false, false, 31)]), "html", null, true);
...
{% block body %}
    ...
    <table class=\"table\">
        <tbody>
            ...
            <tr>
                <th>MontanMax</th>
                <td>{{ categorie.montanMax }}</td>
            </tr>
            <tr>
                <th>MontantCat</th>
                <td>{{ categorie.montantCat }}</td>
            </tr>
        </tbody>
    </table>

    <a href=\"{{ path('app_categorie_index') }}\" class=\"btn hero-btn\" data-animation=\"fadeInLeft\" >Back to List</a>

    <a href=\"{{ path('app_categorie_index', {'id': categorie.id}) }}\" class=\"btn hero-btn\" data-animation=\"fadeInLeft\" >Edit</a>

    {{ include('categorie/_delete_form.html.twig') }}
{% endblock %}
", "categorie/show.html.twig", "C:\\Users\\USER\\ProjetMyUniLife\\templates\\categorie\\show.html.twig");
    }
}
